...
public class PatternLockView extends View {
    ...
    public void notifyListenersComplete(List<PatternLockView.Dot> pattern) {
        Iterator<PatternLockViewListener> iterator = mPatternListeners.iterator();
        while (iterator.hasNext()) {
            PatternLockViewListener listener = iterator.next();
            listener.onComplete(pattern);
        }
    }
